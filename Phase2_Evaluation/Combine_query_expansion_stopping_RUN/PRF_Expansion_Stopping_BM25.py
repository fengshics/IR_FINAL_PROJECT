...
INDEXPATH = "unigram_index_stopped.txt"
DOCUMENTLENGTHPATH = "document_length_stopped.txt"
REL_JUDGEMENTS_FILE_NAME = "../../Given_Corpus_Info/cacm.rel.txt"
PRF_EXPANDED_QUERY_FILE_PATH = "expanded_queries_by_prf_stopped.txt"
...
if __name__ == '__main__':
    ...
    queryID = 0
    file = open("Combine_query_expansion_stopping_BM25_Ranking_result/BM25_with_expansion_prf_stopped.txt", "w")
