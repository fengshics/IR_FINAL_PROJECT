...
INDEXPATH = "unigram_index_stemming.txt"
DOCUMENTLENGTHPATH = "document_length_stemming.txt"
QUERY_FILE_PATH = "../../../Given_Corpus_Info/cacm_stem.query.txt"
...
if __name__ == '__main__':
    ...
    queryID = 0
    file = open("stemming_BM25_Ranking_result/BM25_with_rel_stemming.txt", "w")
